...
---------------------------
  ...
  file.dat <- file.path(dir.wrk, "2011_Family_Tables_19_20_New_LIM.xlsx")
...
write.table(df, file ="2011_Family_Table_19_New_LIM.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2011_Family_Table_20_New_LIM.csv", sep = ",", row.names = FALSE)
...
df1 <- read.table(file ="2011_Family_Table_19_New_LIM.csv", sep = ",")
df2 <- read.table(file ="2011_Family_Table_20_New_LIM.csv", sep = ",")


DFs <- data.frame(cbind(df1, df2[,6:ncol(df2)], col.names = T))


write.table(DFs, file ="2011_Family_Table_19_20_LIM.csv", sep = ",", row.names = FALSE, col.names = TRUE)
