...
file.dat <- file.path(dir.wrk, "2016_Individuals_Tables_1_to_12_Canada.xlsx")
...
write.table(df, file ="2016_Individuals_Table_1_Canada.csv", sep = ",", row.names = FALSE, col.names = TRUE)
...
write.table(df, file ="2016_Individuals_Table_2_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_3A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_3B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_3C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_4_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_5A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_5B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_5C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_6_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_7A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_7B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_7C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_8_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_9_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_10_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_11_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Individuals_Table_12_Canada.csv", sep = ",", row.names = FALSE)
...
df1 <- read.table(file ="2016_Individuals_Table_1_Canada.csv", sep = ",")
nrow(df1)
df2 <- read.table(file ="2016_Individuals_Table_2_Canada.csv", sep = ",")
nrow(df2)
df3 <- read.table(file ="2016_Individuals_Table_3A_Canada.csv", sep = ",")
nrow(df3)
df4 <- read.table(file ="2016_Individuals_Table_3B_Canada.csv", sep = ",")
nrow(df4)
df5 <- read.table(file ="2016_Individuals_Table_3C_Canada.csv", sep = ",")
nrow(df5)
df6 <- read.table(file ="2016_Individuals_Table_4_Canada.csv", sep = ",")
nrow(df6)
df7 <- read.table(file ="2016_Individuals_Table_5A_Canada.csv", sep = ",")
nrow(df7)
df8 <- read.table(file ="2016_Individuals_Table_5B_Canada.csv", sep = ",")
nrow(df8)
df9 <- read.table(file ="2016_Individuals_Table_5C_Canada.csv", sep = ",")
nrow(df9)
df10 <- read.table(file ="2016_Individuals_Table_6_Canada.csv", sep = ",")
nrow(df10)
df11 <- read.table(file ="2016_Individuals_Table_7A_Canada.csv", sep = ",")
nrow(df11)
df12 <- read.table(file ="2016_Individuals_Table_7B_Canada.csv", sep = ",")
nrow(df12)
df13 <- read.table(file ="2016_Individuals_Table_7C_Canada.csv", sep = ",")
nrow(df13)
df14 <- read.table(file ="2016_Individuals_Table_8_Canada.csv", sep = ",")
nrow(df14)
df15 <- read.table(file ="2016_Individuals_Table_9_Canada.csv", sep = ",")
nrow(df15)
df16 <- read.table(file ="2016_Individuals_Table_10_Canada.csv", sep = ",")
nrow(df16)
df17 <- read.table(file ="2016_Individuals_Table_11_Canada.csv", sep = ",")
nrow(df17)
df18 <- read.table(file ="2016_Individuals_Table_12_Canada.csv", sep = ",")
nrow(df18)



DFs <- data.frame(cbind(df1, df2[,6:ncol(df2)],df3[,6:ncol(df3)], df4[,6:ncol(df4)], df5[,6:ncol(df5)], df6[,6:ncol(df6)], df7[,6:ncol(df7)], df8[,6:ncol(df8)], df9[,6:ncol(df9)], df10[,6:ncol(df10)], df11[,6:ncol(df11)], df12[,6:ncol(df12)], df13[,6:ncol(df13)], df14[,6:ncol(df14)], df15[,6:ncol(df15)], df16[,6:ncol(df16)],  df17[,6:ncol(df17)],  df18[,6:ncol(df18)]), col.names = TRUE)
DFs <- na.omit(DFs)
View(DFs)

write.table(DFs, file ="2016_Individuals_Canada.csv", sep = ",", row.names = FALSE, col.names = TRUE)
