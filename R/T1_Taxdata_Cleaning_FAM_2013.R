...
---------------------------
  ...
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
...
write.table(df, file ="2013_Family_Table_1_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_2_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_3A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_3B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_3C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_4A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_4B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_4C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_5A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_5B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_6_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_7_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_8_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_9_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_10_Canada.csv", sep = ",", row.names = FALSE)
...
names(dat1) <- c("City_ID", "Postal_Area", "Postal_Walk", "Geo_Level", "Place_Name", "All_M_15_19_yrs", "All_M_20_24_yrs",	"All_M_25_29_yrs",	"All_M_30_34_yrs",	"All_M_35_39_yrs",	"All_M_40_44_yrs",	"All_M_45_49_yrs",	"All_M_50_54_yrs",	"All_M_55_59_yrs",	"All_M_60_64_yrs",	"All_M_65P_yrs",	"All_M_Total",	"All_F_15_19_yrs",	"All_F_20_24_yrs",	"All_F_25_29_yrs",	"All_F_30_34_yrs",	"All_F_35_39_yrs",	"All_F_40_44_yrs",	"All_F_45_49_yrs",	"All_F_50_54_yrs",	"All_F_55_59_yrs",	"All_F_60_64_yrs",	"All_F_65P_yrs",	"All_F_Total",	"Total_15_19_yrs",	"Total_20_24_yrs",	"Total_25_29_yrs",	"Total_30_34_yrs",	"Total_35_39_yrs",	"Total_40_44_yrs",	"Total_45_49_yrs",	"Total_50_54_yrs",	"Total_55_59_yrs",	"Total_60_64_yrs",	"Total_65P_yrs",	"Total_Total",	"LabInc_M_15_19_yrs",	"LabInc_M_20_24_yrs",	"LabInc_M_25_29_yrs",	"LabInc_M_30_34_yrs",	"LabInc_M_35_39_yrs",	"LabInc_M_40_44_yrs",	"LabInc_M_45_49_yrs",	"LabInc_M_50_54_yrs",	"LabInc_M_55_59_yrs",	"LabInc_M_60_64_yrs",	"LabInc_M_65P_yrs",	"LabInc_M_Total",	"LabInc_F_15_19_yrs",	"LabInc_F_20_24_yrs",	"LabInc_F_25_29_yrs",	"LabInc_F_30_34_yrs",	"LabInc_F_35_39_yrs",	"LabInc_M_40_44_yrs",	"LabInc_F_45_49_yrs",	"LabInc_F_50_54_yrs",	"LabInc_F_55_59_yrs",	"LabInc_F_60_64_yrs",	"LabInc_F_65P_yrs",	"LabInc_F_Total",	"LabInc_Total_15_19_yrs",	"LabInc_Total_20_24_yrs",	"LabInc_Total_25_29_yrs",	"LabInc_Total_30_34_yrs",	"LabInc_Total_35_39_yrs",	"LabInc_Total_40_44_yrs",	"LabInc_Total_45_49_yrs",	"LabInc_Total_50_54_yrs",	"LabInc_Total_55_59_yrs",	"LabInc_Total_60_64_yrs",	"LabInc_Total_65P_yrs",	"LabInc_Total_Total",	"Par_rate_M_15_19_yrs",	"Par_rate_M_20_24_yrs",	"Par_rate_M_25_29_yrs",	"Par_rate_M_30_34_yrs",	"Par_rate_M_35_39_yrs",	"Par_rate_M_40_44_yrs",	"Par_rate_M_45_49_yrs",	"Par_rate_M_50_54_yrs",	"Par_rate_M_55_59_yrs",	"Par_rate_M_60_64_yrs",	"Par_rate_M_65P_yrs	",
                 "Par_rate_M_Total",	"Par_rate_F_15_19_yrs",	"Par_rate_F_20_24_yrs",	"Par_rate_F_25_29_yrs",	"Par_rate_F_30_34_yrs",	"Par_rate_F_35_39_yrs",	"Par_rate_F_40_44_yrs",	"Par_rate_F_45_49_yrs",	"Par_rate_F_50_54_yrs",	"Par_rate_F_55_59_yrs",	"Par_rate_F_60_64_yrs",	"Par_rate_F_65P_yrs",	"Par_rate_F_Total",	"Par_rate_total_15_19_yrs",	"Par_rate_total_20_24_yrs",	"Par_rate_total_25_29_yrs",	"Par_rate_total_30_34_yrs",	"Par_rate_total_35_39_yrs",	"Par_rate_total_40_44_yrs",	"Par_rate_total_45_49_yrs",	"Par_rate_total_50_54_yrs",	"Par_rate_total_55_59_yrs",	"Par_rate_total_60_64_yrs",	"Par_rate_total_65P_yrs",	"Par_rate_Total")
dat1 <- na.omit(dat1)
...
write.table(df, file ="2013_Family_Table_11_Canada.csv", sep = ",", row.names = FALSE)
...
names(dat1) <- c("City_ID", "Postal_Area", "Postal_Walk", "Geo_Level", "Place_Name", "All_M_15_19_yrs", "All_M_20_24_yrs",	"All_M_25_29_yrs",	"All_M_30_34_yrs",	"All_M_35_39_yrs",	"All_M_40_44_yrs",	"All_M_45_49_yrs",	"All_M_50_54_yrs",	"All_M_55_59_yrs",	"All_M_60_64_yrs",	"All_M_65P_yrs",	"All_M_Total",	"All_F_15_19_yrs",	"All_F_20_24_yrs",	"All_F_25_29_yrs",	"All_F_30_34_yrs",	"All_F_35_39_yrs",	"All_F_40_44_yrs",	"All_F_45_49_yrs",	"All_F_50_54_yrs",	"All_F_55_59_yrs",	"All_F_60_64_yrs",	"All_F_65P_yrs",	"All_F_Total",	"Total_15_19_yrs",	"Total_20_24_yrs",	"Total_25_29_yrs",	"Total_30_34_yrs",	"Total_35_39_yrs",	"Total_40_44_yrs",	"Total_45_49_yrs",	"Total_50_54_yrs",	"Total_55_59_yrs",	"Total_60_64_yrs",	"Total_65P_yrs",	"Total_Total",	"EmpIns_M_15_19_yrs",	"EmpIns_M_20_24_yrs",	"EmpIns_M_25_29_yrs",	"EmpIns_M_30_34_yrs",	"EmpIns_M_35_39_yrs",	"EmpIns_M_40_44_yrs",	"EmpIns_M_45_49_yrs",	"EmpIns_M_50_54_yrs",	"EmpIns_M_55_59_yrs",	"EmpIns_M_60_64_yrs",	"EmpIns_M_65P_yrs	",
                 "EmpIns_M_Total",	"EmpIns_F_15_19_yrs",	"EmpIns_F_20_24_yrs",	"EmpIns_F_25_29_yrs",	"EmpIns_F_30_34_yrs",	"EmpIns_F_35_39_yrs",	"EmpIns_F_40_44_yrs",	"EmpIns_F_45_49_yrs",	"EmpIns_F_50_54_yrs",	"EmpIns_F_55_59_yrs",	"EmpIns_F_60_64_yrs",	"EmpIns_F_65P_yrs",	"EmpIns_F_Total",	"EmpIns_total_15_19_yrs",	"EmpIns_total_20_24_yrs",	"EmpIns_total_25_29_yrs",	"EmpIns_total_30_34_yrs",	"EmpIns_total_35_39_yrs",	"EmpIns_total_40_44_yrs",	"EmpIns_total_45_49_yrs",	"EmpIns_total_50_54_yrs",	"EmpIns_total_55_59_yrs",	"EmpIns_total_60_64_yrs",	"EmpIns_total_65P_yrs",	"EmpIns_Total")
dat1 <- na.omit(dat1)
...
write.table(df, file ="2013_Family_Table_12_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_13_Canada.csv", sep = ",", row.names = FALSE)
...
--------------------------- 
  ...
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
dat1 <- read.xlsx(file.dat, sheet = 19, startRow = 3)
...
write.table(df, file ="2013_Family_Table_14A_Canada.csv", sep = ",", row.names = FALSE)
...
--------------------------- 
  ...
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
dat1 <- read.xlsx(file.dat, sheet = 20, startRow = 3)
...
write.table(df, file ="2013_Family_Table_14B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2013_Family_Table_14C_Canada.csv", sep = ",", row.names = FALSE)
...
---------------------------   
  ...
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
dat1 <- read.xlsx(file.dat, sheet = 22, startRow = 4)
...
write.table(df, file ="2013_Family_Table_15_Canada.csv", sep = ",", row.names = FALSE)

---------------------------   
  
  #read file path for individual income table 23 to clean-up column names
  
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
dat1 <- read.xlsx(file.dat, sheet = 23, startRow = 4)
...
#Extract the BC subset of the data in table 23
...
#Output the generated table 23

write.table(df, file ="2013_Family_Table_17_Canada.csv", sep = ",", row.names = FALSE)

---------------------------   
  
  #read file path for individual income table 24 to clean-up column names
  
  file.dat <- file.path(dir.wrk, "2013_Family_Tables_1_to_18_Canada.xlsx")
dat1 <- read.xlsx(file.dat, sheet = 24, startRow = 4)
names(dat1) <- c("City_ID", "Postal_Area", "Postal_Walk", "Geo_Level", "Place_Name", "Couple_Fam_0_Child", "Couple_Fam_1_Child", "Couple_Fam_2_Child", "Couple_Fam_3_Child", "Couple_Fam_Total", "Couple_Fam_Median_Income_0_Child", "Couple_Fam_Median_Income_1_Child", "Couple_Fam_Median_Income_2_Child", "Couple_Fam_Median_Income_3_Child", "Couple_Fam_Median_Income_Total", "Persons_With_0_Child", "Persons_With_1_Child", "Persons_With_2_Child", "Persons_With_3_Child", "Persons_With_Total", "Children_0_17_1_Child", "Children_0_17_2_Child", "Children_0_17_3_Child",  "Children_0_17_Total", "Persons_65P_0_Child", "Persons_65P_1_Child", "Persons_65P_2_Child", "Persons_65P_3_Child", "Persons_65P_Total",
                 "LowIncome_Couple_Fam_0_Child", "LowIncome_Couple_Fam_1_Child", "LowIncome_Couple_Fam_2_Child", "LowIncome_Couple_Fam_3_Child", "LowIncome_Couple_Fam_Total", "LowIncome_Couple_Fam_Median_Income_0_Child", "LowIncome_Couple_Fam_Median_Income_1_Child", "LowIncome_Couple_Fam_Median_Income_2_Child", "LowIncome_Couple_Fam_Median_Income_3_Child", "LowIncome_Couple_Fam_Median_Income_Total", "LowIncome_Persons_With_0_Child", "LowIncome_Persons_With_1_Child", "LowIncome_Persons_With_2_Child", "LowIncome_Persons_With_3_Child", "LowIncome_Persons_With_Total", "LowIncome_Children_0_17_1_Child", "LowIncome_Children_0_17_2_Child", "LowIncome_Children_0_17_3_Child",  "LowIncome_Children_0_17_Total", "LowIncome_Persons_65P_0_Child", "LowIncome_Persons_65P_1_Child", "LowIncome_Persons_65P_2_Child", "LowIncome_Persons_65P_3_Child", "LowIncome_Persons_65P_Total",
                 "LPF_1_Child", "LPF_2_Child", "LPF_3_Child", "LPF_Total", "LPF_Median_Income_1_Child", "LPF_Median_Income_2_Child", "LPF_Median_Income_3_Child", "LPF_Median_Income_Total", "LPF_Persons_With_1_Child", "LPF_Persons_With_2_Child", "LPF_Persons_With_3_Child", "LPF_Persons_With_Total", "LPF_Children_0_17_1_Child", "LPF_Children_0_17_2_Child", "LPF_Children_0_17_3_Child",  "LPF_Children_0_17_Total", "LPF_Persons_65P_1_Child", "LPF_Persons_65P_2_Child", "LPF_Persons_65P_3_Child", "LPF_Persons_65P_Total",
                 "Low_Income_LPF_1_Child", "Low_Income_LPF_2_Child", "Low_Income_LPF_3_Child", "Low_Income_LPF_Total", "Low_Income_LPF_Median_Income_1_Child", "Low_Income_LPF_Median_Income_2_Child", "Low_Income_LPF_Median_Income_3_Child", "Low_Income_LPF_Median_Income_Total", "Low_Income_LPF_Persons_With_1_Child", "Low_Income_LPF_Persons_With_2_Child", "Low_Income_LPF_Persons_With_3_Child", "Low_Income_LPF_Persons_With_Total", "Low_Income_LPF_Children_0_17_1_Child", "Low_Income_LPF_Children_0_17_2_Child", "Low_Income_LPF_Children_0_17_3_Child",  "Low_Income_LPF_Children_0_17_Total", "Low_Income_LPF_Persons_65P_1_Child", "Low_Income_LPF_Persons_65P_2_Child", "Low_Income_LPF_Persons_65P_3_Child", "Low_Income_LPF_Persons_65P_Total",
...
#Extract the BC subset of the data in table 24
...
#Output the generated table 24

write.table(df, file ="2013_Family_Table_18_Canada.csv", sep = ",", row.names = FALSE)
...
df1 <-  read.table(file ="2013_Family_Table_1_Canada.csv", sep = ",")
df2 <-  read.table(file ="2013_Family_Table_2_Canada.csv", sep = ",")
df3 <-  read.table(file ="2013_Family_Table_3A_Canada.csv", sep = ",")
df4 <-  read.table(file ="2013_Family_Table_3B_Canada.csv", sep = ",")
df5 <-  read.table(file ="2013_Family_Table_3C_Canada.csv", sep = ",")
df6 <-  read.table(file ="2013_Family_Table_4A_Canada.csv", sep = ",")
df7 <-  read.table(file ="2013_Family_Table_4B_Canada.csv", sep = ",")
df8 <-  read.table(file ="2013_Family_Table_4C_Canada.csv", sep = ",")
df9 <-  read.table(file ="2013_Family_Table_5A_Canada.csv", sep = ",")
df10 <-  read.table(file ="2013_Family_Table_5B_Canada.csv", sep = ",")
df11 <-  read.table(file ="2013_Family_Table_6_Canada.csv", sep = ",")
df12 <-  read.table(file ="2013_Family_Table_7_Canada.csv", sep = ",")
df13 <-  read.table(file ="2013_Family_Table_8_Canada.csv", sep = ",")
df14 <-  read.table(file ="2013_Family_Table_9_Canada.csv", sep = ",")
df15 <-  read.table(file ="2013_Family_Table_10_Canada.csv", sep = ",")
df16 <-  read.table(file ="2013_Family_Table_11_Canada.csv", sep = ",")
df17 <-  read.table(file ="2013_Family_Table_12_Canada.csv", sep = ",")
df18 <-  read.table(file ="2013_Family_Table_13_Canada.csv", sep = ",")
df19 <-  read.table(file ="2013_Family_Table_14A_Canada.csv", sep = ",")
df20 <-  read.table(file ="2013_Family_Table_14B_Canada.csv", sep = ",")
df21 <-  read.table(file ="2013_Family_Table_14C_Canada.csv", sep = ",")
df22 <-  read.table(file ="2013_Family_Table_15_Canada.csv", sep = ",")
df23 <-  read.table(file ="2013_Family_Table_17_Canada.csv", sep = ",")
df24 <-  read.table(file ="2013_Family_Table_18_Canada.csv", sep = ",")
...
DFs <- data.frame(cbind(df1, df2[,6:ncol(df2)], df3[,6:ncol(df3)], df4[,6:ncol(df4)], df5[,6:ncol(df5)], df6[,6:ncol(df6)], df7[,6:ncol(df7)], df8[,6:ncol(df8)], df9[,6:ncol(df9)], df10[,6:ncol(df10)], df11[,6:ncol(df11)], df12[,6:ncol(df12)], 
                        df13[,6:ncol(df13)], df14[,6:ncol(df14)], df15[,6:ncol(df15)], df16[,6:ncol(df16)], df17[,6:ncol(df17)], df18[,6:ncol(df18)], df19[,6:ncol(df19)], df20[,6:ncol(df20)], df21[,6:ncol(df21)], df22[,6:ncol(df22)], df23[,6:ncol(df23)], df24[,6:ncol(df24)], col.names = T))

DFs <- na.omit(DFs)

write.table(DFs, file ="2013_Family_Table.csv", sep = ",", row.names = FALSE, col.names = TRUE)
