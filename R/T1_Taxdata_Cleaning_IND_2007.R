...
file.dat <- file.path(dir.wrk, "2007_IND_Tables_1_to_8_Canada.xlsx")
...
write.table(df, file ="2007_Individuals_Table_1_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_2_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_3A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_3B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_3C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_4_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_5A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_5B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_5C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_6_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_7A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_7B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_7C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2007_Individuals_Table_8_Canada.csv", sep = ",", row.names = FALSE)
...
df1 <- read.table(file ="2007_Individuals_Table_1_Canada.csv", sep = ",")
df2 <- read.table(file ="2007_Individuals_Table_2_Canada.csv", sep = ",")
df3 <- read.table(file ="2007_Individuals_Table_3A_Canada.csv", sep = ",")
df4 <- read.table(file ="2007_Individuals_Table_3B_Canada.csv", sep = ",")
df5 <- read.table(file ="2007_Individuals_Table_3C_Canada.csv", sep = ",")
df6 <- read.table(file ="2007_Individuals_Table_4_Canada.csv", sep = ",")
df7 <- read.table(file ="2007_Individuals_Table_5A_Canada.csv", sep = ",")
df8 <- read.table(file ="2007_Individuals_Table_5B_Canada.csv", sep = ",")
df9 <- read.table(file ="2007_Individuals_Table_5C_Canada.csv", sep = ",")
df10 <- read.table(file ="2007_Individuals_Table_6_Canada.csv", sep = ",")
df11 <- read.table(file ="2007_Individuals_Table_7A_Canada.csv", sep = ",")
df12 <- read.table(file ="2007_Individuals_Table_7B_Canada.csv", sep = ",")
df13 <- read.table(file ="2007_Individuals_Table_7C_Canada.csv", sep = ",")
df14 <- read.table(file ="2007_Individuals_Table_8_Canada.csv", sep = ",")
...
DFs <- data.frame(cbind(df1, df2[,6:ncol(df2)],df3[,6:ncol(df3)], df4[,6:ncol(df4)], df5[,6:ncol(df5)], df6[,6:ncol(df6)], df7[,6:ncol(df7)], df8[,6:ncol(df8)], df9[,6:ncol(df9)], df10[,6:ncol(df10)], df11[,6:ncol(df11)], df12[,6:ncol(df12)], df13[,6:ncol(df13)], df14[,6:ncol(df14)]), col.names = T)
DFs <- na.omit(DFs)

write.table(DFs, file ="2007_Individuals_Canada.csv", sep = ",", row.names = FALSE, col.names = TRUE)
