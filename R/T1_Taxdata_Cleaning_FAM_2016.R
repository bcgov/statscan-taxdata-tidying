...
---------------------------
  ...
  file.dat <- file.path(dir.wrk, "2016_Family_Tables_1_to_18_Canada.xlsx")
...
write.table(df, file ="2016_Family_Table_1_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_2_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_3A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_3B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_3C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_4A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_4B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_4C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_5A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_5B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_6_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_7_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_8_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_9_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_10_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_13_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_14A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_14B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_14C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_15_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_17_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2016_Family_Table_18_Canada.csv", sep = ",", row.names = FALSE)
...
df1 <-  read.table(file ="2016_Family_Table_1_Canada.csv", sep = ",")
df2 <-  read.table(file ="2016_Family_Table_2_Canada.csv", sep = ",")
df3 <-  read.table(file ="2016_Family_Table_3A_Canada.csv", sep = ",")
df4 <-  read.table(file ="2016_Family_Table_3B_Canada.csv", sep = ",")
df5 <-  read.table(file ="2016_Family_Table_3C_Canada.csv", sep = ",")
df6 <-  read.table(file ="2016_Family_Table_4A_Canada.csv", sep = ",")
df7 <-  read.table(file ="2016_Family_Table_4B_Canada.csv", sep = ",")
df8 <-  read.table(file ="2016_Family_Table_4C_Canada.csv", sep = ",")
df9 <-  read.table(file ="2016_Family_Table_5A_Canada.csv", sep = ",")
df10 <-  read.table(file ="2016_Family_Table_5B_Canada.csv", sep = ",")
df11 <-  read.table(file ="2016_Family_Table_6_Canada.csv", sep = ",")
df12 <-  read.table(file ="2016_Family_Table_7_Canada.csv", sep = ",")
df13 <-  read.table(file ="2016_Family_Table_8_Canada.csv", sep = ",")
df14 <-  read.table(file ="2016_Family_Table_9_Canada.csv", sep = ",")
df15 <-  read.table(file ="2016_Family_Table_10_Canada.csv", sep = ",")
df16 <-  read.table(file ="2016_Family_Table_14A_Canada.csv", sep = ",")
df17 <-  read.table(file ="2016_Family_Table_14B_Canada.csv", sep = ",")
df18 <-  read.table(file ="2016_Family_Table_14C_Canada.csv", sep = ",")
df19 <-  read.table(file ="2016_Family_Table_15_Canada.csv", sep = ",")
df20 <-  read.table(file ="2016_Family_Table_17_Canada.csv", sep = ",")
df21 <-  read.table(file ="2016_Family_Table_18_Canada.csv", sep = ",")
...
write.table(DFs, file ="2016_Family_Table.csv", sep = ",", row.names = FALSE, col.names = TRUE)
