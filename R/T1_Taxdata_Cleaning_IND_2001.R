...
---------------------------
  ...
  file.dat <- file.path(dir.wrk, "2001_IND_Tables_1_to_8_Canada.xlsx")
...
write.table(df, file ="2001_Individuals_Table_1_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_2_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_3A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_3B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_3C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_4_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_5A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_5B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_5C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_6_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_7A_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_7B_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_7C_Canada.csv", sep = ",", row.names = FALSE)
...
write.table(df, file ="2001_Individuals_Table_8_Canada.csv", sep = ",", row.names = FALSE)

--------------------------- 
  #combine/merge all subsheets into one table
  
  df1 <- read.table(file ="2001_Individuals_Table_1_Canada.csv", sep = ",")
df2 <- read.table(file ="2001_Individuals_Table_2_Canada.csv", sep = ",")
df3 <- read.table(file ="2001_Individuals_Table_3A_Canada.csv", sep = ",")
df4 <- read.table(file ="2001_Individuals_Table_3B_Canada.csv", sep = ",")
df5 <- read.table(file ="2001_Individuals_Table_3C_Canada.csv", sep = ",")
df6 <- read.table(file ="2001_Individuals_Table_4_Canada.csv", sep = ",")
df7 <- read.table(file ="2001_Individuals_Table_5A_Canada.csv", sep = ",")
df8 <- read.table(file ="2001_Individuals_Table_5B_Canada.csv", sep = ",")
df9 <- read.table(file ="2001_Individuals_Table_5C_Canada.csv", sep = ",")
df10 <- read.table(file ="2001_Individuals_Table_6_Canada.csv", sep = ",")
df11 <- read.table(file ="2001_Individuals_Table_7A_Canada.csv", sep = ",")
df12 <- read.table(file ="2001_Individuals_Table_7B_Canada.csv", sep = ",")
df13 <- read.table(file ="2001_Individuals_Table_7C_Canada.csv", sep = ",")
df14 <- read.table(file ="2001_Individuals_Table_8_Canada.csv", sep = ",")
...
write.table(DFs, file ="2001_Individuals_Canada.csv", sep = ",", row.names = FALSE, col.names = TRUE)
