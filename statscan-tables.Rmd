...
# Introduction 
Currently, the data files in IDD are income estimates for individuals ranging from years 2000 up to 2015. Each table in a year is an aggregation of sub-tables as listed in Table 1.
The income estimates for families range from years 2004 up to 2016. Each table in a year is an aggregation of all sub-tables as listed in Table 2. 
The technical Reference Guide for the Annual Income Estimates for Census Families, Individuals and Seniors can be found in documentation folder. For information about this product or the wide range of services and data available from Statistics Canada, visit their [website](www.statcan.gc.ca).
